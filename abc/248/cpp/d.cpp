...
int main() {
    ...
    rep(i,0,q) {
        ...
        cin >> l >> r >> x;
        l--;
        //vector<int> check(a.begin()+l,a.begin()+r);
        //sort(check.begin(),check.end());
        cout << lower_bound(idx.at(x).begin(),idx.at(x).end(),r) - lower_bound(idx.at(x).begin(),idx.at(x).end(),l) << "\n";
        //if (num==x) cout << 1 << "\n";
        //else cout << 0 << "\n";
        //cout << count(check.begin(),check.end(),x) << "\n";
    }
